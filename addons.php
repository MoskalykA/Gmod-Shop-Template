...
<template>
  <div>
    ...
    <!--<div class="row">
    <?php
        //$result = $conn->query("SELECT * FROM `addons` WHERE 1"); 
        //while ($donnees = $result->fetch()) { ?>
            <div class="column">
                <div class="max-w-sm rounded overflow-hidden shadow-lg">
                  <img src=<?php //echo '"' . $donnees['image_link'] . '"' ?>>
                  <div class="px-6 py-4">
                    <div class="font-bold text-xl mb-2"><?php //echo $donnees['name'] ?></div>
                    <p class="text-gray-700 text-base">
                        <?php //echo $donnees['description_short'] ?>
                    </p>
                  </div>
                  <div class="px-6 py-4">
